{
  ...
  inputs."calibre-master".owner = "riinr";
  inputs."calibre-master".repo = "flake-nimble";
  inputs."calibre-master".ref = "flake-pinning";
  inputs."calibre-master".dir = "nimpkgs/c/calibre/master";

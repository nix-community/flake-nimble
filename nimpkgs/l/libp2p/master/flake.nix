{
  ...
  inputs."https://github.com/ba0f3/dnsclient.nim".url = "path:../../../h/https://github.com/ba0f3/dnsclient.nim";
  ...
  outputs = { self, nixpkgs, src-libp2p-master, ...}@deps:
    let lib = import ./lib.nix;
    in lib.mkRefOutput {
      inherit self nixpkgs ;
      src = src-libp2p-master;
      deps = builtins.removeAttrs deps ["self" "nixpkgs" "src-libp2p-master"];

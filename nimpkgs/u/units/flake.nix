{
  ...
  inputs."units-master".owner = "riinr";
  inputs."units-master".repo = "flake-nimble";
  inputs."units-master".ref = "flake-pinning";
  inputs."units-master".dir = "nimpkgs/u/units/master";

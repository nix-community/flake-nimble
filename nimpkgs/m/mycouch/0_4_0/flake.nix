{
  ...
  inputs."https://github.com/hamidb80/coverage".url = "path:../../../h/https://github.com/hamidb80/coverage";
  ...
  outputs = { self, nixpkgs, src-mycouch-0_4_0, ...}@deps:
    let lib = import ./lib.nix;
    in lib.mkRefOutput {
      inherit self nixpkgs ;
      src = src-mycouch-0_4_0;
      deps = builtins.removeAttrs deps ["self" "nixpkgs" "src-mycouch-0_4_0"];

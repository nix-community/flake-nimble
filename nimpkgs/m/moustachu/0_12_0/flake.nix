{
  ...
  inputs.src-moustachu-0_12_0.inputs.nixpkgs.follows = "nixpkgs";
  ...
  outputs = { self, nixpkgs, flakeNimbleLib, src-moustachu-0_12_0, ...}@deps:
    let lib = flakeNimbleLib.lib;
    in lib.mkRefOutput {
      inherit self nixpkgs ;
      src = src-moustachu-0_12_0;
      deps = builtins.removeAttrs deps ["self" "nixpkgs" "flakeNimbleLib" "src-moustachu-0_12_0"];

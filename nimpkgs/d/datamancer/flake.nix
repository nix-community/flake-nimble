{
  ...
  inputs."datamancer-v0_2_0".owner = "riinr";
  inputs."datamancer-v0_2_0".repo = "flake-nimble";
  inputs."datamancer-v0_2_0".ref = "flake-pinning";
  inputs."datamancer-v0_2_0".dir = "nimpkgs/d/datamancer/v0_2_0";

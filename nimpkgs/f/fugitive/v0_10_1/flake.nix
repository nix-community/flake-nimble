{
  ...
  inputs.src-fugitive-v0_10_1.owner = "citycide";
  ...
  outputs = { self, nixpkgs, src-fugitive-v0_10_1, ...}@deps:
    let lib = import ./lib.nix;
    in lib.mkRefOutput {
      inherit self nixpkgs ;
      src = src-fugitive-v0_10_1;
      deps = builtins.removeAttrs deps ["self" "nixpkgs" "src-fugitive-v0_10_1"];
